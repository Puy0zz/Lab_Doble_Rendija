...
datos=pd.DataFrame(dat,columns=["x_3", "promedio_3"])
#print(datos) #184
ydata=(datos["promedio_3"][:145]).astype(float)
xdata=datos["x_3"][:145].astype(float)
u=(xdata)-1450#2990
#print(u)
a=0.1
d=0.356
...
ax[0].set_ylabel("Conteo de fotónes por segundo ($s^{-1}$)")
ax[0].grid()
ax[0].set_title("Conteo de fotónes por segundo \n contra distancia en la pantalla")
